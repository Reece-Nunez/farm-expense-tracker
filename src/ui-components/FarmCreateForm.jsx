...
export default function FarmCreateForm(props) {
  ...
  const resetStateValues = () => {
    setOwnerSub(initialValues.ownerSub);
    setName(initialValues.name);
    setFarmType(initialValues.farmType);
    ...
    setEstablishedYear(initialValues.establishedYear);
    setWebsite(initialValues.website);
    setBusinessRegistration(initialValues.businessRegistration);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createFarm.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "FarmCreateForm")}
      {...rest}
    >
      <TextField
        label="Owner sub"
