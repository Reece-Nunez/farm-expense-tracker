...
// Allowed payment methods (adjust as needed)
  ...
  const validateRows = () => {
    for (let i = 0; i < rows.length; i++) {
      ...
      if (!allowedPaymentMethods.includes(r.paymentMethod)) {
        toast.error(`Row ${i + 1} has invalid payment method: ${r.paymentMethod}`);
        return false;
      }
    }
    return true;
  ...
  return (
    <div className="max-w-5xl mx-auto p-4 bg-white shadow rounded">
      ...
      <p className="text-sm text-gray-500 mb-2">
        Fix any missing/invalid fields and click "Save Imported Income."
      </p>
